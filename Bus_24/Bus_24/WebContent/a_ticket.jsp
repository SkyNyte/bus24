...
class Ticket 
{
    ...
    public Ticket(int adminID, String name,  String source, String destination, Date departureDate, Date returnDate, int capacity, int price) 
    {
...
ResultSet rs = stmt.executeQuery("SELECT * FROM admin ORDER BY admin_id DESC LIMIT 1");
rs.next();
...
<div class="card">
  ...
  <form method="POST" action="payment.jsp" class="form">
    ...
    <p>Customer Name: <%= ticket.getName() %></p>
