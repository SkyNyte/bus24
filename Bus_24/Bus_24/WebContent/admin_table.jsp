...
<body>
<h2 align="center"><i>Admin Table</i></h2>
<%
...
String sql1 = "INSERT INTO admin(admin_id, name, source, destination, departure_date, return_date, capacity, price) VALUES (?,?, ?, ?, ?, ?, ?, ?)";
...
%>
<tr>
<td><%= rs2.getInt("admin_id") %></td>
<td><%= rs2.getString("name") %></td>
<td><%= rs2.getString("source") %></td>
<td><%= rs2.getString("destination") %></td>
<td><%= rs2.getString("departure_date") %></td>
<td><%= rs2.getString("return_date") %></td>
<td><%= rs2.getInt("capacity") %></td>
